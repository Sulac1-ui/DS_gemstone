...
class ModelTrainerConfig:
    trained_model_file_path = os.path.join("artifact", "ModelTrainer.pkl")


class ModelTrainer:
    def __init__(self):
        # Fixed attribute name alignment
    ...
    def initiate_model_training(self, train_array, test_array):
        try:
            ...
            # Fixed slicing: Index -1 correctly isolates the target column for ytrain and ytest
